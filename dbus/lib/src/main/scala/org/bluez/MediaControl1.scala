...
object MediaControl1 extends toolbox8.dbus.common.DBInterfaceCompanion[MediaControl1](classOf[MediaControl1], "org.bluez.MediaControl1") {
  ...
  object Instances {
    ...
    object `org.bluez` extends BusInstances("org.bluez") {
      ...
      val `/org/bluez/hci0/dev_B8_27_EB_50_3A_5D` = instance("/org/bluez/hci0/dev_B8_27_EB_50_3A_5D")
